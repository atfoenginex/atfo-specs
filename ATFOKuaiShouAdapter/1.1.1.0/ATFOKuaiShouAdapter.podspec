Pod::Spec.new do |s|
  s.name         = 'ATFOKuaiShouAdapter'
  s.version      = '1.1.1.0'
  s.summary      = 'Open Ad ATFOKuaiShouAdapter'
  ...
  s.source       = { :http => 'https://maven.cxwlad.com/repository/atfo-sdk-static/Public/SDK/1.1.0.10/ATFOKuaiShouAdapter.zip' }
