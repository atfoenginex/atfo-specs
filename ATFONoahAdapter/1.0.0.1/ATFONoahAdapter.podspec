Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://maven.cxwlad.com/repository/atfo-sdk-static/Public/SDK/1.0.0.1/ATFONoahAdapter.zip' }
  ...
  s.resources = 'ATFOpenAdSDK/Classes/Noah/Frameworks/NoahAdSdks/**/*.bundle'
