Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://maven.cxwlad.com/repository/atfo-sdk-static/Public/SDK/1.1.0.12/ATFOGroMoreAdapter.zip' }
  s.dependency 'ATFOpenAdSDK', '~> 1.2.0.0'
  s.dependency 'PTGAdFramework', '2.2.84'
  s.dependency 'PTGGroMoreAdapter','2.2.80.0'
  s.dependency 'MSMobAdSDK/MS','2.7.7.2'
  s.dependency 'MSMobAdSDK/CSJMMeiShuAdapter','2.7.7.2'
  s.dependency 'Ads-CN/BUAdSDK', '7.1.0.9'
  s.dependency 'Ads-CN/CSJMediation', '7.1.0.9'
